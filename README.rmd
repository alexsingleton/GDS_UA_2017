...
* 10:40 - 12:10 Public Seminar
    ...
    * [Bringing New Forms of Data to the Analysis of Cities - Dani Arribas-Bel](/GDS_UA_2017/presentation/darribas.pdf)
* _12.10 - 13.10 - LUNCH_
* 13.10 - 14.00 - [Lecture - Introduction to Geographic Data Science for Urban Analytics](/GDS_UA_2017/presentation/Intro_GDS_UA.pdf)
...
* _12:10 - 13:10 - LUNCH_
* 13:10 - 14:00 - [Lecture - Reproducible Research](/GDS_UA_2017/presentation/Reproducible_Research.pdf)
...
* 09:20 - 10:50 - Lecture / Independent - Introduction to the Group Project
* 10:50 - 12:10 - Student Project Planning - Stage 1 / Student Project Brief Review - Stage 2
* _12:10 - 13:10 - LUNCH_
* 13:10 - 14:00 - Student Project Brief Review - Stage 2
* 14:45 - 15:30 - Independent - Student Led Analysis - Stage 3
...
* [Practical - Data Viz 4 - Mapping Flows](/GDS_UA_2017/Mapping_Flows/)

# Group Project Assignment

The group project will be introduced at 09.20 on Day 3. The projects is designed so that you can implement those skills developed during the practical sessions within an applied context. The projects are to be conducted in groups, and the assesment will be a 10-12 minute presentation in the final session on Thursday 26th January. 

## Assignment 

Class template: [download](/GDS_UA_2017/class_template.Rmd)
...
The following script will install all the additional R packages that will be needed for this course; however, these are also referenced within the practical documents where functions are used. *If you are asked to restart R, click no during these installs.*

```{r eval=FALSE}
pcks <- c("devtools","RCurl","XML","jpeg","png","proj4","stringi","ggplot2","scales","XLConnect","rgdal","raster","doBy","classInt","RColorBrewer","maptools","tmap","googleway","lubridate","ggmap","plotly","spatialEco")
...
# If you have issues with either ggplot or ggmap it would be worth installing these
